...
// Handle the Sign Up Logic Route
router.post("/register", function(req, res){
    ...
    if(req.body.adminCode === "secretcode333"){
   ...
   async.waterfall([
        ...
        function(token, user, done){
            var smtpTransport = nodemailer.createTransport({
                service: "Gmail",
                auth: {
                    user: "rgipson1@gmail.com",
                    pass: process.env.GMAILPW
                }
            });
            var mailOptions = {
                to: user.email,
                from: "rgipson1@gmail.com",
...
// Enter New Password and Confirm the New Password
